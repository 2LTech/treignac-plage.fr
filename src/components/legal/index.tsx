...
const Legal = () => (
  <main>
    ...
    <section className="hero" aria-label="Mentions Légales">
      <div className="legalContent">
        ...
        <p>
          ...
          utilisateurs du site internet https://treignac-plage.fr/
        ...
        <ul>
          ...
          <li>
            ...
            Cedex 1, (contact téléphonique : 1007).
          </li>
        </ul>
        ...
        <p>
          ...
          lors de l’accès au site https://treignac-plage.fr/.
          <br />
        ...
        <p>
          ...
          <br />
          La navigation sur le site https://treignac-plage.fr/ est susceptible
