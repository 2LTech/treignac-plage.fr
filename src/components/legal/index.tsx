...
const Legal = () => (
  <main>
    ...
    <Section className="legalContent" aria-label="Mentions Légales">
      ...
      <p>
        ...
        utilisateurs du site internet https://treignac-plage.fr/ l&apos;identité
        des différents intervenants dans le cadre de sa réalisation et de son
        suivi:
      </p>
      <p>Propriétaire du site : TREIGNAC PLAGE </p>
      <ul>
        <li>Contact : contact@treignac-plage.fr (+33) 05 55 73 61 01</li>
        <li>Adresse : 36 ROUTE DE GUERET 19260 TREIGNAC</li>
      </ul>
      <p>Identification de l&apos;entreprise : TREIGNAC PLAGE</p>
      <ul>
        <li>SIREN : 101455509</li>
        <li>Adresse postale : 36 ROUTE DE GUERET 19260 TREIGNAC</li>
      </ul>
      <p>Directeur de la publication : 2LTech</p>
      <ul>
        <li>Contact : contact@2ltech.fr</li>
        <li>
          Hébergeur : OVH SAS, 2 rue Kellermann - BP 80157 - 59053 Roubaix Cedex
          1, (contact téléphonique : 1007).
        </li>
      </ul>

      <h1>2 - Propriété intellectuelle et contrefaçons.</h1>
      <p>
        La Société TREIGNAC PLAGE est propriétaire des droits de propriété
        ...
        préalable de la Société TREIGNAC PLAGE.
        <br />
      ...
      <p>
        La Société TREIGNAC PLAGE ne pourra être tenu pour responsable des
        dommages directs et indirects causés au matériel de l’utilisateur, lors
        de l’accès au site https://treignac-plage.fr/.
        <br />
        La Société TREIGNAC PLAGE décline toute responsabilité quant à
        l’utilisation qui pourrait être faite des informations et contenus
        présents sur https://treignac-plage.fr/.
        <br />
        La Société TREIGNAC PLAGE s’engage à sécuriser au mieux le site
        https://treignac-plage.fr/, cependant sa responsabilité ne pourra être
        mise en cause si des données indésirables sont importées et installées
        sur son site à son insu.
      </p>
      <h1>4 - CNIL et gestion des données personnelles.</h1>
      <p>
        Le site https://treignac-plage.fr/ ne collecte pas de données
        personnelles.
      </p>
      <h1>5 - Liens hypertextes et cookies</h1>
      <p>
        Le site https://treignac-plage.fr/ contient des liens hypertextes vers
        d’autres sites et dégage toute responsabilité à propos de ces liens
        externes ou des liens créés par d’autres sites vers
        https://treignac-plage.fr/.
        <br />
        La navigation sur le site https://treignac-plage.fr/ est susceptible de
        ...
        enregistrés pour une durée maximale de 1 mois.
      </p>
      <h1>6 - Droit applicable et attribution de juridiction.</h1>
      <p>
        Tout litige en relation avec l’utilisation du site
        https://treignac-plage.fr/ est soumis au droit français. En dehors des
        cas où la loi ne le permet pas, il est fait attribution exclusive de
        juridiction aux tribunaux compétents de Tulle.
      </p>
    </Section>
